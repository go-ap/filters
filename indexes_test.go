...
var indexableActivities = []vocab.LinkOrIRI{
	&vocab.Actor{
		...
		PreferredUsername: vocab.DefaultLangValue("jDoe"),
		Summary:           vocab.DefaultLangValue("An anonymous dude"),
	},
	&vocab.Actor{
		ID:                "https://federated.local/~alice",
		Type:              vocab.PersonType,
		AttributedTo:      vocab.IRI("https://federated.local"),
		Name:              vocab.DefaultLangValue("Alice in Wonderland"),
		PreferredUsername: vocab.DefaultLangValue("alice"),
	},
	&vocab.Object{
		ID:           "https://federated.local/objects/1",
		Type:         vocab.PageType,
		...
		Name:         vocab.DefaultLangValue("Link to example.com"),
		Summary:      vocab.DefaultLangValue("An example for a link to example.com"),
		URL:          vocab.IRI("https://example.com"),
	},
	&vocab.Activity{
		ID:     "https://federated.local/1",
	...
	&vocab.Activity{
		...
		Type:    vocab.FlagType,
		Content: vocab.DefaultLangValue("flagged object"),
